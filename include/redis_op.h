 ...
 */
/* -------------------------------------------*/
int rop_range_list(redisContext *conn, const char *key, int from_pos, int count, RVALUES values, int *get_num);
...
/* -------------------------------------------*/
/**
 * @brief  rop_set_string  插入一个string类型key 和value
 *
 * @param conn
 * @param key
 * @param value
...
/* -------------------------------------------*/
/**
 * @brief  rop_set_hash  插入一个hash类型key field和value
 *
 * @param conn
 * @param key
 * @param field
